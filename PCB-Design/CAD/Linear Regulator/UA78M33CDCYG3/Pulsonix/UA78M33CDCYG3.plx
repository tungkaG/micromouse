...
//384170/1717166/2.50/4/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "UA78M33CDCYG3" (originalName "UA78M33CDCYG3")
	...
	(compDef "UA78M33CDCYG3" (originalName "UA78M33CDCYG3") (compHeader (numPins 4) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "INPUT") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "COMMON_1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "OUTPUT") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "COMMON_2") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "UA78M33CDCYG3"))
		...
		(attr "Mouser Part Number" "595-UA78M33CDCYG3")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/UA78M33CDCYG3?qs=0O%2FZFlpUpJU0kFSZAC76Kw%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "UA78M33CDCYG3")
		(attr "Description" "Linear Voltage Regulators 3.3 V 500mA Fix Pos Voltage Regulator")
		(attr "<Hyperlink>" "http://www.ti.com/lit/ds/symlink/ua78m.pdf")
		(attr "<Component Height>" "1.8")
		(attr "<STEP Filename>" "UA78M33CDCYG3.stp")
