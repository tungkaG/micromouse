...
//932531/1717166/2.50/2/3/Capacitor
...
(library Library_1
	...
	(patternDef "CAPC2012X152N" (originalName "CAPC2012X152N")
		(multiLayer
	...
	(symbolDef "08053C334KAZ2A" (originalName "08053C334KAZ2A")
	...
	(compDef "08053C334KAZ2A" (originalName "08053C334KAZ2A") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "08053C334KAZ2A"))
		(attachedPattern (patternNum 1) (patternName "CAPC2012X152N")
			(numPads 2)
			(padPinMap
		...
		(attr "Manufacturer_Part_Number" "08053C334KAZ2A")
		(attr "Description" "AVX 330nF Multilayer Ceramic Capacitor (MLCC) 25 V 0805 SMT Max. Op. Temp. +125C")
		(attr "<Hyperlink>" "")
		(attr "<Component Height>" "1.52")
		(attr "<STEP Filename>" "08053C334KAZ2A.stp")
