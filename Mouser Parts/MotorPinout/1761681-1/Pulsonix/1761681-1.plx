...
(library Library_1
	...
	(patternDef "SHDR6W67P254_2X3_1524X916X922P" (originalName "SHDR6W67P254_2X3_1524X916X922P")
		...
		(layerContents (layerNumRef 28)
			(line (pt -5.08 -3.175) (pt -5.08 6.175) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -5.08 6.175) (pt 10.16 6.175) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 10.16 6.175) (pt 10.16 -3.175) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 10.16 -3.175) (pt -5.08 -3.175) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "1761681-1" (originalName "1761681-1") (compHeader (numPins 6) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://www.te.com/commerce/DocumentDelivery/DDEController?Action=showdoc&DocId=Customer+Drawing%7F1761681%7FA1%7Fpdf%7FEnglish%7FENG_CD_1761681_A1.pdf%7F1761681-1")
		(attr "<Component Height>" "9.22")
		(attr "<STEP Filename>" "1761681-1.stp")
		(attr "<STEP Offsets>" "X=2.54;Y=1.33;Z=9.22")
