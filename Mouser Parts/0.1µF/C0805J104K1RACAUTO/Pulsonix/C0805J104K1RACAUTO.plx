...
(library Library_1
	(padStyleDef "r157_110"
		(holeDiam 0)
		(padShape (layerNumRef 1) (padShapeType Rect)  (shapeWidth 1.1) (shapeHeight 1.57))
	...
	(patternDef "CAPC2012X140N" (originalName "CAPC2012X140N")
		(multiLayer
			(pad (padNum 1) (padStyleRef r157_110) (pt -0.81, 0) (rotation 0))
			(pad (padNum 2) (padStyleRef r157_110) (pt 0.81, 0) (rotation 0))
		)
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0, 0) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -1.51 0.94) (pt 1.51 0.94) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 1.51 0.94) (pt 1.51 -0.94) (width 0.05))
		)
	...
	(symbolDef "C0805J104K1RACAUTO" (originalName "C0805J104K1RACAUTO")
	...
	(compDef "C0805J104K1RACAUTO" (originalName "C0805J104K1RACAUTO") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "C0805J104K1RACAUTO"))
		...
		(attr "Manufacturer_Part_Number" "C0805J104K1RACAUTO")
		(attr "Description" "SMD Auto X7R FO, Ceramic, 0.1 uF, 10%, 100 VDC, X7R, SMD, MLCC, Open Mode, Automotive Grade, 0805, 0.6 mm")
		(attr "<Hyperlink>" "https://search.kemet.com/component-documentation/download/specsheet/C0805J104K1RACAUTO")
		(attr "<Component Height>" "1.4")
		(attr "<STEP Filename>" "C0805J104K1RACAUTO.stp")
