...
int main() 
{
    ...
    // myTimer1 func to setup TCKPS and PR1 register of Timer1 (and check what is the max boundary (max Time our timer can wait)
    
    
    
    
    unsigned int success2 = setupTimer2(10); // 0 up to 629ms configurable
    setupPWM();
    setupUART1();
    ...
    unsigned int success = setupTimer1(10); // 0 up to 629ms configurable
    ...
    return 0;
    // TODO: set another timer that e.g. toggles LED with different interrupt level
    // and read/code dsPIC starter manual up to page 37
}
